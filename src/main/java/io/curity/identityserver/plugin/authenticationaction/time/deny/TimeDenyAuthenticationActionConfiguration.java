...
public interface TimeDenyAuthenticationActionConfiguration extends Configuration
{
    ...
    @Description("Deny access before this time (24h time format)")
    @PatternConstraint(timeRegExp)
    String getNoAccessBefore ();

    @Description("Deny access after this time (24h time format)")
    @PatternConstraint(timeRegExp)
    String getNoAccessAfter ();
