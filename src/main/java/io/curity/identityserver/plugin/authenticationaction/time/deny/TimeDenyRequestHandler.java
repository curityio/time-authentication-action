...
public class TimeDenyRequestHandler implements ActionCompletionRequestHandler<Request>
{
    private final IntermediateAuthenticationState _intermediateAuthenticationState;
    private final SessionManager _sessionManager;
//    private final Json _json;

    private final static Logger _logger = LoggerFactory.getLogger(TimeDenyRequestHandler.class);


    public TimeDenyRequestHandler(IntermediateAuthenticationState intermediateAuthenticationState,
                                  TimeDenyAuthenticationActionConfiguration configuration)
    {
